...
abstract class $IngredientCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, double carbonFootprint});
}
...
class _$_Ingredient implements _Ingredient {
  const _$_Ingredient(
      {required this.id, required this.name, required this.carbonFootprint});
  ...
  @override
  String toString() {
    return 'Ingredient(id: $id, name: $name, carbonFootprint: $carbonFootprint)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, carbonFootprint);
...
abstract class _Ingredient implements Ingredient {
  const factory _Ingredient(
      ...
      required final double carbonFootprint}) = _$_Ingredient;
